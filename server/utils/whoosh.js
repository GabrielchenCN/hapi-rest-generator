...
class Whoosh {
    constructor(response) {
        this.statusCode = (response && response.code) || 200;
        this.message = (response && response.message) || Whoosh.STATUS_CODES[this.statusCode];
    ...
    static create(statusCode, message, data) {
        return {
        	...
        	message:message || Whoosh.STATUS_CODES[statusCode],
        	data:data || null,
        };
    }
    ...
    static NoContent(data,message) {
        return this.create(204, message, data)
    }
}

Whoosh.STATUS_CODES = Object.setPrototypeOf({
    '100': 'Continue',
